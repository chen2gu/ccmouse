...
kube::version::get_version_vars() {
  ...
  if [[ '%' == "%" ]]; then
    KUBE_GIT_COMMIT='7dfcacd1cfcbdfe74b28f2473fb107e9a47ec905'
    KUBE_GIT_TREE_STATE="archive"
    # When a 'git archive' is exported, the 'HEAD -> master, refs/__gh__/pull/71371/rebase, refs/__gh__/pull/71280/rebase' below will look
    # something like 'HEAD -> release-1.8, tag: v1.8.3' where then 'tag: '
    # can be extracted from it.
    if [[ 'HEAD -> master, refs/__gh__/pull/71371/rebase, refs/__gh__/pull/71280/rebase' =~ tag:\ (v[^ ,]+) ]]; then
